...
/* ── Minimal footer strip: Developed by + Copyright only ── */
const FooterStrip = () => (
  <div
    style={{
      position: "relative",
      zIndex: 1,
      borderTop: "1px solid rgba(0,255,194,0.12)",
      paddingTop: "1rem",
      paddingBottom: "1.25rem",
      textAlign: "center",
    }}
  >
    <p className="font-mono text-sm" style={{ color: "rgba(255,255,255,0.6)", marginBottom: "4px" }}>
      Developed by{" "}
    ...
    <p className="font-mono text-sm" style={{ color: "rgba(255,255,255,0.35)", margin: 0 }}>
    ...
    >
      ...
      <div
        style={{
          ...
          background: "linear-gradient(135deg,rgba(2,13,20,0.82) 0%,rgba(5,13,26,0.90) 30%,rgba(12,8,24,0.95) 60%,rgba(8,9,9,0.85) 100%)",
      ...
      {/* Main content — grows to push footer strip down */}
      <div className="relative flex flex-1 flex-col items-center justify-center gap-10" style={{ zIndex: 1 }}>
        {/* Page title */}
        <h1
          className="font-mono text-3xl font-bold sm:text-4xl sm:tracking-[5px]"
          style={{
            marginTop: "6rem",
        ...
        {/* Glass form card */}
        <div
          className="container mx-auto mb-10 w-11/12 rounded-3xl p-8 sm:w-3/4 md:w-3/5 lg:w-1/2 xl:w-2/5 2xl:w-1/3"
          style={{
            position: "relative",
